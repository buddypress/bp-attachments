...
jq(document).ready( function() {
	...
	/* On reset button click, reset the form and shrink if */
	jq( '#whats-new-form' ).on( 'reset', function() {
	...
	/* Texarea auto-resize */
	$whats_new.on( 'keyup', function( event ) {
		var self = jq( this );

		if ( this.scrollHeight <= self.innerHeight() ) {
			return;
		}
